...
public class InsertFusionTables extends Thread{
	private static Vector<Double> longitude = new Vector<Double>(); 
	private static Vector<Double> latitude = new Vector<Double>();
	private static String type = "";
	private static Vector<Integer> flag= new Vector<Integer>();;

	public InsertFusionTables(Vector<Double> longitude,Vector<Double> latitude,String type, Vector<Integer> flag){
		InsertFusionTables.longitude = longitude;
		InsertFusionTables.latitude = latitude;
		InsertFusionTables.type = type;
		InsertFusionTables.flag = flag;
   ...
   */
  private static final String APPLICATION_NAME = "ECEN489-Project2/1.0";
  ...
  public void run(){
    try {
      ...
      String tableId = "1KnHwnzm1Ygl2lKvTFA-r1i9Uvb_FSKZ8_KdGXi3R";     //insert to existing table
