...
public class DatabaseHandler implements Runnable {
    ...
    private ArrayList<AndroidPacket2> dataset = null;

    public DatabaseHandler(ArrayList<AndroidPacket2> _dataset) throws ClassNotFoundException {
