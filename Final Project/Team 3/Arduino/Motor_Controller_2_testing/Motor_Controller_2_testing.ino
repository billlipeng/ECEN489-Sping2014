...
//  pinMode(PULSE, OUTPUT);
  ...
  analogWriteFrequency(PULSE, 100);
   ...
   // Calculating angle to rotate
     rotAngle = angle - positionNow;
        ...
        if(angle != -1 && abs(rotAngle) >= 5)
        {
          ...
          stepsRot = (int) (((float)(abs(rotAngle)))/(360.0/steps));
...
void rotate(int number)
{
    ...
    { 
      while(digitalRead(PULSE)); //wait until the next duty cycle 
