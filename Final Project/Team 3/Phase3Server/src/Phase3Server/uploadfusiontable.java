...
public class uploadfusiontable {
	...
	private static Credential authorize() throws Exception {
	    GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(
	        JSON_FACTORY, new InputStreamReader(
	            uploadfusiontable.class.getResourceAsStream("/client_secretsYYX.json")));
	...
	String createTable1(String TableName) throws IOException {
		String TableID;
	    // Create a new table
	    Table table = new Table();
	    table.setName(UUID.randomUUID().toString());
	    ...
	    table.setColumns(Arrays.asList(new Column().setName("latitude").setType("LOCATION"),
	        new Column().setName("longitude").setType("LOCATION"),
	        new Column().setName("weight").setType("NUMBER"),
	        new Column().setName("RSSI").setType("NUMBER")));
	...
	public void update1(String tableID,double[] Latitude,double[] Longitude, double[] RSSI, double[] WEIGHT){
...
//		      for (int num = 0;num<iteration;num++){
		      for(int iter=0;iter < RSSI.length ; iter++){
//		      	  int itertemp = num*200+ iter;
		    	  Sqlstring =Sqlstring+" INSERT INTO " + tableId + " (latitude,longitude,RSSI,weight) "
					        + "VALUES (" + Latitude[iter] + ", " +Longitude[iter] + ", " + RSSI[iter]+ ", " + WEIGHT[iter] + ");";
...
//		      int l = 0;
//		      for(l = 200*iteration;l<totalnum;l++ ){
//		    	  Sqlstring =Sqlstring+" INSERT INTO " + tableId + " (latitude,longitude,RSSI) "
//					        + "VALUES (" + Latitude[l] + ", " +Longitude[l] + ", " + RSSI[l]  + ");";
//		      }
//		      
//		      try {
//			    	HttpContent content = ByteArrayContent.fromString(null, "sql=" + Sqlstring);
